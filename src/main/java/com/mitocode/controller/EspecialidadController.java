...
public class EspecialidadController {
	...
	public ResponseEntity<List<Especialidad>> listar(){
		List<Especialidad> listaEspecialidad = service.listar();
		return new ResponseEntity<List<Especialidad>>(listaEspecialidad, HttpStatus.OK);
	}
	
	@GetMapping("/{id}")
	public ResponseEntity<Especialidad> leerPorId(@PathVariable("id") Integer id) {
		Especialidad objEspecialidad =service.leerporId(id);
	...
	public Resource<Especialidad> leerPorIdHateoas(@PathVariable("id") Integer id) {
		...
		Resource<Especialidad> resource = new Resource<Especialidad>(objEspecialidad);
	...
	@PutMapping
	public ResponseEntity<Object> modificar(@RequestBody Especialidad pac) {
